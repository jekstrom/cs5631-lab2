...
extern uint32 muscle::_totalHashtableCollisions;
#endif
...
int main(int argc, char ** argv)
{
   ...
   bool fastClear = false;
   {
      ...
      printf("Finished torture test successfully, exiting.\n");
   }

#ifdef MUSCLE_COLLECT_HASHTABLE_COLLISION_STATISTICS
   printf("Total hashtable collisions:  "UINT32_FORMAT_SPEC"\n", _totalHashtableCollisions);
#endif
}
