...
${OBJECTDIR}/BlockGroup.o: BlockGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BlockGroup.o BlockGroup.cpp
...
${TESTDIR}/tests/BlockLinkedListTest.o: tests/BlockLinkedListTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/BlockLinkedListTest.o tests/BlockLinkedListTest.cpp
...
${OBJECTDIR}/BlockLinkedList_nomain.o: ${OBJECTDIR}/BlockLinkedList.o BlockLinkedList.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/BlockLinkedList_nomain.o BlockLinkedList.cpp;\
	else  \
...
${OBJECTDIR}/Block_nomain.o: ${OBJECTDIR}/Block.o Block.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Block_nomain.o Block.cpp;\
	else  \
...
${OBJECTDIR}/BlockGroup_nomain.o: ${OBJECTDIR}/BlockGroup.o BlockGroup.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/BlockGroup_nomain.o BlockGroup.cpp;\
	else  \
