...
${OBJECTDIR}/File.o: File.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/File.o File.cpp
...
${TESTDIR}/tests/BlockLinkedListTest.o: tests/BlockLinkedListTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/BlockLinkedListTest.o tests/BlockLinkedListTest.cpp
...
${OBJECTDIR}/File_nomain.o: ${OBJECTDIR}/File.o File.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/File_nomain.o File.cpp;\
	else  \
