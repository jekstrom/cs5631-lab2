...
void PrintHexBytes(const ByteBufferRef & bbRef, const char * optDesc, uint32 numColumns, FILE * optFile)
{
...
void LogHexBytes(int logLevel, const ByteBufferRef & bbRef, const char * optDesc, uint32 numColumns)
{
